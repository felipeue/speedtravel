			...
			<div id="main" class="wrapper style1">
				<div class="container">
					<header class="major">
						...
						<form method="post" action="detalle_factura2.php">			
								<select class="negro" size="1" name="numero">
      							<?php
      							$empresa = $_SESSION['empresa'];
								require_once("../connect.php");
                                require_once("../validadores.php");
                                $result = mysql_query("SELECT facturas.numero, facturas.orden_de_compra FROM facturas, orden_de_compra where facturas.orden_de_compra = orden_de_compra.numero and orden_de_compra.empresa = '$empresa' ");            
                                while ($row = mysql_fetch_row($result))
                                {
                                    echo "<option value='$row[0]'>Nº factura : $row[0] - Orden de compra : $row[1]</option>";   
                                }
								?>
     							</select><br>
     							<div class="12u$">
