	...
	<body>
		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				<div class="container">
					<header class="major">
						<h2>Intranet Clientes</h2>
						<p>Revise el menú de búsquedas para realizar operaciones</p>
						<ul class="actions">
								<li><a href="clientes_cambiar_pass.php" class="button special big">Cambiar contraseña</a></li>
								<li><a href="buscadorcliente.php" class="button special big">Buscador gastos</a></li>
							</ul>
					</header>
