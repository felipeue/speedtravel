			...
			<div id="main" class="wrapper style1">
				<div class="container">
					<header class="major">
						...
						<form name="formulario" method="post" id="formulario" action="busqueda_odc2.php" >			
								<select class="negro" size="1" name="pasaje">
      							<?php
								require_once("../connect.php");
                                require_once("../validadores.php");
                                $empresa = $_SESSION['empresa'];
                                $result = mysql_query("SELECT empresa, numero FROM orden_de_compra where empresa = '$empresa'");            
                                while ($row = mysql_fetch_row($result))
                                {
                                    echo "<option value='$row[1]'>Empresa : $row[0] - Número: $row[1]</option>";   
                                }
								?>
     							</select><br>
     							<div class="12u$">
