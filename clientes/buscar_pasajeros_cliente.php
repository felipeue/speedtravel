			...
			<div id="main" class="wrapper style1">
				<div class="container">
					<header class="major">
						...
						<form method="post" action="buscar_pasajeros_cliente2.php">
								<p>Turno</p>			
                                ...
                                $result = mysql_query("SELECT distinct pasajero.turno  FROM pasajero, pasaje, orden_de_compra where pasajero.rut=pasaje.rut_pasajero and pasaje.orden_de_compra = orden_de_compra.numero and orden_de_compra.empresa = '$empresa'"); 
                                	echo "<p>Turno</p>";
                                ...
                                require_once("../validadores.php");
                                $empresa = $_SESSION['empresa'];
                                $result = mysql_query("SELECT distinct pasajero.centro_de_costo FROM pasajero, pasaje, orden_de_compra where pasajero.rut=pasaje.rut_pasajero and pasaje.orden_de_compra = orden_de_compra.numero and orden_de_compra.empresa = '$empresa'"); 
