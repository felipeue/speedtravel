	...
	<body>
		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				<div class="container">
					<header class="major">
						<h2>Cambie su clave</h2>
						<p>Ingrese nueva clave</p>
						<form method="post" action="validar_clave_final.php">
								<div class="row uniform 50%">
									<div class="12u$">
										<p>Nueva clave</p><input type="password" name="password" id="password" value="" placeholder="Ingrese clave" required/>
									</div>
									<div class="12u$">
									...
									<div class="12u$">
										<ul class="actions">
											<li><input type="submit" value="Siguiente" class="special" /></li>
										</ul>
									</div>
								</div>
							</form>
