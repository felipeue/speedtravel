	...
	<body>
		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				<div class="container">
					<header class="major">
							<form method="post" action="validar_factura.php">
								<div class="row uniform 50%">
									<div class="6u 12u$(xsmall)">
										<p>Numero de Factura</p><input type="text" name="numero" id="numero" value="" placeholder="Numero" required/>
									</div>
									<div class="6u$ 12u$(xsmall)">
									...
									<div class="12u$">
										<ul class="actions">
											<li><input type="submit" value="Ingresar Factura" class="special" /></li>
										</ul>
									</div>
								</div>
							</form>
