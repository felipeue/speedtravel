			...
			<div id="main" class="wrapper style1">
				<div class="container">
					<header class="major">
						...
						<form method="post" action="eliminar_pasaje2.php">			
								<select class="negro" size="1" name="id">
      							<?php
								require_once("../connect.php");
                                require_once("../validadores.php");
                                $result = mysql_query("SELECT pasaje.id, pasajero.nombre,pasajero.apellido, pasajero.rut, pasaje.linea_aerea, pasaje.codigo_reserva, pasaje.numero_boleto, pasaje.orden_de_compra, pasaje.ticket_pendiente, pasaje.modificado FROM pasaje, pasajero WHERE pasaje.rut_pasajero = pasajero.rut");            
