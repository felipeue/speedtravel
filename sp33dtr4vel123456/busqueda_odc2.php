									...
									<tbody>
										<?
										   $numero = $_POST["pasaje"];
											require_once("../connect.php");
                                			require_once("../validadores.php");
                                			$result = mysql_query("SELECT numero, valor_inicial, empresa, mes, ano,dia,detalle FROM orden_de_compra WHERE numero='$numero'"); 
								...
								<table class="alt">
									...
									<tfoot>
										...
										<tr>
											...
											<?
											$numero = $_POST["pasaje"];
											$result = mysql_query("SELECT SUM(valor_boleto) FROM pasaje where orden_de_compra ='$numero'");
											while ($row = mysql_fetch_row($result))
											{
											$total = $row[0];
