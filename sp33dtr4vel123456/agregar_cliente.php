							...
							<form method="post" action="validar_cliente.php">
								<div class="row uniform 50%">
									<div class="6u 12u$(xsmall)">
										<p>Nombre</p><input type="text" name="nombre" id="nombre" value="" placeholder="Ingrese nombre" required/>
									</div>
									<div class="6u$ 12u$(xsmall)">
										<p>Apellido</p><input type="text" name="apellido" id="apellido" value="" placeholder="Ingrese apellido" required/>
									</div>
									<div class="6u$ 12u$(xsmall)">
										<p>Rut</p><input type="text" name="rut" id="rut" value="" placeholder="Ingrese rut" required/>
									</div>
									<div class="6u$ 12u$(xsmall)">
										<p>Empresa</p><input type="text" name="empresa" id="empresa" value="" placeholder="Ingrese empresa(Este es el nombre para las ODC)" required/>
									</div>
									<div class="6u$ 12u$(xsmall)">
										<p>Clave</p><input type="password" name="password" id="password" value="" placeholder="Ingrese clave" required/>
									</div>
								    <div class="6u$ 12u$(xsmall)">
										<p>Confirme clave</p><input type="password" name="password2" id="password2" value="" placeholder="Ingrese clave" required/>
									</div>
									
									<div class="12u$">
										<ul class="actions">
											<li><input type="submit" value="Nuevo cliente" class="special" /></li>
										</ul>
									</div>
								</div>
							</form>
