			...
			<div id="main" class="wrapper style1">
				<div class="container">
					<header class="major">
						...
						<p>Ingrese clave actual</p>
						<form method="post" action="validar_clave.php">
								<div class="row uniform 50%">
									<div class="12u$">
										<p>Clave actual</p><input type="password" name="password" id="password" value="" placeholder="Ingrese clave" required/>
									</div>
									<div class="12u$">
										<ul class="actions">
