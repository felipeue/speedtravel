			...
			<div id="main" class="wrapper style1">
				<div class="container">
					<header class="major">
						...
						<ul class="actions">
								<li><a href="buscar_pasajeros_adm.php" class="button special big">Buscar gasto por pasajero</a></li>
								<li><a href="buscar_odc_adm.php" class="button special big">Buscar gasto por orden de compra</a></li>
