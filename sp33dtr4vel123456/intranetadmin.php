			...
			<div id="main" class="wrapper style1">
				<div class="container">
					<header class="major">
						...
						<p>Revise el menu para realizar operaciones</p>
						<ul class="actions">
								<li><a href="admin_cambiar_pass.php" class="button special big">Cambiar contraseña</a></li>
								<li><a href="buscadoradm.php" class="button special big">Buscador gastos</a></li>
				...
				<div class="container">
					<header class="major">
						<ul class="actions">
								...
								<li><a href="eliminar_datos.php" class="button special big">Eliminar datos</a></li>
				...
				<div class="container">
					<header class="major">
						<ul class="actions">
								...
								<li><a href="pasaje_pendiente.php" class="button special big">Usar pasaje pendiente</a></li>
